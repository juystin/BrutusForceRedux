...
class RemoteSql:
    ...
    def __init__(self, host, user, password):
        ...
        self.cursor.execute('''DROP DATABASE IF EXISTS brutusmaps''')
        self.cursor.execute('''CREATE DATABASE brutusmaps''')
        self.cursor.execute('''USE brutusmaps''')
    ...
    def insert_building_list(self, building_list):
        if len(building_list) > 0:
            for building in tqdm(building_list, desc="Inserting buildings..."):
                ...
                VALUES (%s, %s, %s, %s, %s, %s)''', (building["buildingNumber"], building["name"], building["buildingCode"],
